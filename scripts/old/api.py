...
core_url = 'http://prod.idea-heroes.com:3010/api'
...
if __name__ == '__main__':
    jwt = get_jwt(tool_email, 'dueV2kae')
    print(jwt)
    ...
    #    print(mission["_id"], mission["created"])


    report = get("missions/5c2dc289c3a6940e662a6a87/report")
